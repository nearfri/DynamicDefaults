...
open class PropertyListEncoder2 {
...
public class _PlistEncoder : Encoder {
    // MARK: Properties
    ...
    fileprivate(set) public var codingPath: [CodingKey] {
        didSet {
            print("PlistEncoder codingPath: \(codingPath)")
        }
    }
...
fileprivate struct _PlistKeyedEncodingContainer<K : CodingKey> : KeyedEncodingContainerProtocol {
    ...
    private(set) public var codingPath: [CodingKey] {
        didSet {
            print("KeyedContainer codingPath: \(codingPath)")
        }
    }
...
fileprivate struct _PlistUnkeyedEncodingContainer : UnkeyedEncodingContainer {
    ...
    private(set) public var codingPath: [CodingKey] {
        didSet {
            print("UnkeyedContainer codingPath: \(codingPath)")
        }
    }
...
public class _PlistDecoder : Decoder {
    // MARK: Properties
...
fileprivate struct _PlistKeyedDecodingContainer<K : CodingKey> : KeyedDecodingContainerProtocol {
    ...
    private func _superDecoder(forKey key: CodingKey) throws -> Decoder {
        ...
        return _PlistDecoder(referencing: value, at: self.decoder.codingPath)
    }
